 ...
 */
public class Upcoming extends Fragment implements MovieAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = v.findViewById(R.id.container_upcoming);
    ...
    private void getMovie() {
        String url = GET_URL + "movie/upcoming?api_key=" + TOKEN;
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    mMovieAdapter.setOnItemClickListener(Upcoming.this);
