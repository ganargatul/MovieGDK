 ...
 */
public class Top_Rated extends Fragment implements MovieAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = v.findViewById(R.id.container_tv);
    ...
    private void getMovie() {
        String url = GET_URL + "movie/top_rated?api_key=" + TOKEN;
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    mMovieAdapter.setOnItemClickListener(Top_Rated.this);
